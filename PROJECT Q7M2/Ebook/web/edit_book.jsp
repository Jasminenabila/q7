...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<%
                          String idebook,judul,deskripsi,foto,gambar;
                      ...
                      <form role="form" action="UpdateBook" method="POST" enctype="multipart form-data">
								...
								<button type="submit" class="btn btn-primary">Update File</button>
                                                                ...
                                                                <br>             
                        <form role="form" action="UpdatePDF" method="POST" enctype="multipart form-data">
							
								<div class="form-group">
                                                                        <input class="hidden"  value="<%=idebook%>" name="id" readonly="" required="" >
								</div>
                                                        
                                                                <div class="form-group">
									<label>File PDF</label>
                                                                        <input type="file" name="pdf" value="<%=foto%>" required=""> 
								</div>
								<button type="submit" class="btn btn-primary">Update PDF</button>
							
						</form>
                                                                
                <form role="form" action="UpdateFoto" method="POST" enctype="multipart/form-data">
							
				<div class="form-group">
                                    <input type="text"  value="<%=idebook%>" name="id" readonly="" required="">
				</div>				
				<div class="form-group">
                                    <label>Gambar</label>
                                    <input type="file" name="foto" value="<%=gambar%>" required="">
