...
public final class input_005fadmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                               <form role=\"form\" action=\"AddAdmin\" method=\"POST\">\n");
      out.write("\t\t\t\t\t\t\t\n");
      ...
      out.write("                                                                        <input class=\"form-control\" name=\"nama\" data-minlength=\"6\" required=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("                                                        \n");
      out.write("                                                                <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label>Alamat</label>\n");
      out.write("                                                                        <textarea class=\"form-control\" name=\"alamat\" rows=\"3\" required=\"\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("                                                        \n");
      out.write("                                                                <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label>Username</label>\n");
      out.write("                                                                        <input class=\"form-control\" name=\"user\" required=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
