...
public final class tables_005fbook_jsp extends org.apache.jasper.runtime.HttpJspBase
                      ...
                      try{
                        ...
                        for(int i = 0;i < data.size()-1;i+=5)
                        {
                            //fac_code, fac_name, fac_email, fac_phone
                                ...
                                String file = "/upload/" + (String) data.get(i+3);      
                                ...
                                out.println("<td><img src='"+request.getContextPath()+gambar+"' width='100'></td>");
                                out.println("<td>");
