...
public final class htmlcss_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("         <li><a href=\"index-1.html\">about</a></li>\n");
      out.write("         <li class=\"current\"><a href=\"ebooks.jsp\">Portfolio</a></li>      \n");
      out.write("       </ul>\n");
      out.write("    </nav>\n");
      out.write("    \n");
                        ...
                        for(int i = 0;i < data.size()-1;i+=4)
                        {
                            //fac_code, fac_name, fac_email, fac_phone
                                ...
                                String foto = "/upload/" + (String) data.get(i+3);      
                                  ...
                                  out.println(judul);
                                  out.println("<br>");
                                  out.println("<h1>Nama Ebook</h1><br>");
