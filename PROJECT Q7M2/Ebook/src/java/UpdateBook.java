...
//                String uploadPath2 = obj2.r_configureUpload(getServletContext().getRealPath(""), "foto");
//                
...
//        
             mBook book = new mBook();
            book.setIdEBook(request.getParameter("id"));
            book.setJudul(request.getParameter("nama"));
            book.setdeskripsi(request.getParameter("deskripsi"));
           // obj1.setStockBarang(Integer.valueOf(request.getParameter("txtStok")));
            int i = book.doUpdate();
            if(i > 0){
                response.sendRedirect("tables_book.jsp?ket=Sukses");
            }else{
                response.sendRedirect("tables_book.jsp?ket=Gagal");
            }
      }
    }
